...
public class Player : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (UserInput.instance.Sprint)
        {
            horizontalMove = UserInput.instance.Move.x * runSpeed;
        }
        else
        {
            horizontalMove = UserInput.instance.Move.x * walkSpeed;
        }
        ...
        if (UserInput.instance.JumpPressed && !controller.jumpBlocked)
        {
        ...
        else if (controller.rb2D.linearVelocity. y > 0 && UserInput.instance.JumpReleased)
        {
            jumpCancel = true;
        }
        ...
        else if (!UserInput.instance.Crouch)
        {
            crouch = false;
        }
